...
void DeviceBehaviourUltimateBase::note_on(uint8_t channel, uint8_t note, uint8_t velocity) {
...
void DeviceBehaviourUltimateBase::note_off(uint8_t channel, uint8_t note, uint8_t velocity) {
...
void DeviceBehaviourUltimateBase::control_change (uint8_t inChannel, uint8_t inNumber, uint8_t inValue) {
