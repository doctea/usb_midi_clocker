...
/*void chocolate_handle_control_change(uint8_t inChannel, uint8_t inNumber, uint8_t inValue) {
    ...
    if (behaviour_chocolate!=nullptr) behaviour_chocolate->control_change(inChannel, inNumber, inValue);
}*/
...
void chocolate_handle_note_on(uint8_t inChannel, uint8_t inNumber, uint8_t inVelocity) {
    ...
    if (behaviour_chocolate!=nullptr) behaviour_chocolate->note_on(inChannel, inNumber, inVelocity);
}
