...
class PolyphonicBehaviour : virtual public DeviceBehaviourUltimateBase {
    ...
    virtual void setup_saveable_settings() override {
        ...
        register_setting(new VarSetting<bool>("Output 1", "Allowed by Auto", &this->allow_voice_for_auto[0]), SL_SCOPE_SCENE);
        register_setting(new VarSetting<bool>("Output 2", "Allowed by Auto", &this->allow_voice_for_auto[1]), SL_SCOPE_SCENE);
        register_setting(new VarSetting<bool>("Output 3", "Allowed by Auto", &this->allow_voice_for_auto[2]), SL_SCOPE_SCENE);
        register_setting(new VarSetting<bool>("Output 4", "Allowed by Auto", &this->allow_voice_for_auto[3]), SL_SCOPE_SCENE);
    }
