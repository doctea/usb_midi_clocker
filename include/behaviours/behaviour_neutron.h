...
class DeviceBehaviour_Neutron : virtual public DeviceBehaviourSerialBase, virtual public ClockedBehaviour, public MIDIBassBehaviour, public ModwheelReceiver {
