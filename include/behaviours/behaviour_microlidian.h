...
class DeviceBehaviour_Microlidian : virtual public DeviceBehaviourUSBBase, virtual public DividedClockedBehaviour, virtual public MIDI_CC_Source { //}, public ModwheelReceiver {
    ...
    public:
        ...
        DeviceBehaviour_Microlidian() : DividedClockedBehaviour() {
            this->addParameterInput("uM-Env1", "Microlidian", (byte)1 /*MUSO_CC_CV_1*/, (byte)1);
            this->addParameterInput("uM-Env2", "Microlidian", (byte)7 /*MUSO_CC_CV_2*/, (byte)1);
            this->addParameterInput("uM-Env3", "Microlidian", (byte)11 /*MUSO_CC_CV_3*/, (byte)1);
            this->addParameterInput("uM-Env4", "Microlidian", (byte)71 /*MUSO_CC_CV_4*/, (byte)1);
            this->addParameterInput("uM-Env5", "Microlidian", (byte)74 /*MUSO_CC_CV_5*/, (byte)1);
        }
