    ...
    public:
        ...
        virtual int display(Coord pos, bool selected, bool opened) override {
            ...
            for (unsigned int i = 0 ; i < max_slots ; i++) {
                ...
                //if (project.is_selected_scene_number_empty(i)) {
        ...
        virtual bool knob_left() override {
            ...
            //project.select_scene_number(ui_selected_number);
        ...
        virtual bool button_select() override {
            ...
            //bool success = project.load_scene(); //selected_scene_number);
            ...
            if (success) {
                //loaded_scene_number = ui_selected_number;
        ...
        virtual bool button_right() override {
            //project.select_scene_number(ui_selected_number);
            //this->target->*move_to_slot_callback(ui_selected_number);
            //bool success = project.save_scene(ui_selected_number); //, &mpk49_loop_track);
            this->move_to_slot_number(ui_selected_number);
            ...
            if (success) {
                //loaded_scene_number = ui_selected_number;
                char msg[tft->get_c_max()] = "";
                snprintf(msg, max_length, "Saved %i", this->get_loaded_slot()); //->target->*getter_callback()); //project.loaded_scene_number);
                menu->set_message_colour(GREEN);
                menu->set_last_message(msg);
            } else {
                char msg[tft->get_c_max()] = "";
