...
class MIDIOutputWrapper : public IMIDICCTarget, public IMIDINoteTarget {
    ...
    public:
        ...
        virtual void sendNoteOn(uint8_t in_pitch, uint8_t velocity, uint8_t channel) {
        ...
        virtual void sendNoteOff(uint8_t in_pitch, uint8_t velocity, uint8_t channel) {
            if (!is_valid_note(in_pitch)) return;
